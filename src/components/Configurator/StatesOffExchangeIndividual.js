...
class StatesOffExchangeIndividual extends React.Component {
  state = {
    state_option: [],
  ...
  handleChange = () => {
    ...
    console.log({ post });
    if (this.props.individualOnExchange === true)
    ...
    else if (this.props.individualOffExchange === true)
...
const ReduxStatesOffExchangeIndividual = connect(mapStateToProps)(
  StatesOffExchangeIndividual
);
export default withStyles(styles)(ReduxStatesOffExchangeIndividual);
